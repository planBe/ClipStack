...
- [x] Global hotkey (⌥⇧⌘V) to open the menu without the mouse — shipped in v0.5; default chord changed twice in pre-1.0 to dodge real-world conflicts (⌘⇧V → ⌃⌘V on 2026-05-17 to avoid VS Code's Markdown Preview; ⌃⌘V → ⌥⇧⌘V on 2026-05-21 to avoid Terminal and other apps). Configurable hotkey is the v1.1 fix.
